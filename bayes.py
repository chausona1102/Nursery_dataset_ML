...
def train_and_save_best_bayes():
    ...
    if best_model is not None:
        ...
        print("✅ Đã lưu mô hình Naive Bayes tốt nhất vào naive_bayes_best.pkl")

def test_bayes():
    train_and_save_best_bayes()
